...
(assert (forall ((v Nat) (w Nat) (x Nat) (y Nat) (z Lst)) (= (drop (succ v) (drop w (drop x (cons y z)))) (drop v (drop w (drop x z)))) ))
(assert (forall ((u Nat) (v Nat) (w Nat) (x Nat) (y Nat) (z Lst)) (= (drop (succ u) (drop v (drop (succ w) (cons x (cons y z))))) (drop (succ u) (drop v (drop w (cons x z))))) ))
(assert (not (forall ((x Nat) (y Nat) (w Nat) (z Lst)) (= (drop w (drop x (drop y z))) (drop y (drop x (drop w z)))) )))
(check-sat)
(exit)
