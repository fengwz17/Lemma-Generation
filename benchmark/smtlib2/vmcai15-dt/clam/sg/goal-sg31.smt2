...
(assert (forall ((x Lst) (y Lst)) (= (qreva (qreva x y) nil) (append (rev y) x)) ))
(assert (forall ((x Lst) (y Lst)) (= (qreva (qreva x (rev y)) nil) (append y x)) ))
(assert (not (forall ((x Lst)) (= (qreva (qreva x nil) nil) x) )))
(check-sat)
(exit)
