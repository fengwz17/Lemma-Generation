...
(assert (forall ((w Lst) (z Lst) (x Nat) (y Nat)) (= (even (len (append w z))) (even (len (append w (cons x (cons y z)))))) ))
(assert (not (forall ((x Lst) (y Lst)) (= (even (len (append x y))) (even (len (append y x)))) )))
(check-sat)
(exit)
