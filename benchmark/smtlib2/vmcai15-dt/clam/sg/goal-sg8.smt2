...
(assert (forall ((w Nat) (x Nat) (y Nat) (z Lst)) (= (drop (succ w) (drop x (cons y z))) (drop w (drop x z))) ))
(assert (forall ((v Nat) (w Nat) (x Nat) (y Nat) (z Lst)) (= (drop (succ v) (drop (succ w) (cons x (cons y z)))) (drop (succ v) (drop w (cons x z)))) ))
(assert (not (forall ((x Nat) (y Nat) (z Lst)) (= (drop x (drop y z)) (drop y (drop x z))) )))
(check-sat)
(exit)
