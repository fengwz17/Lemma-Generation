...
(assert (forall ((w Lst) (x Nat) (y Nat) (z Lst)) (= (len (append w (cons x (cons y z)))) (succ (succ (len (append w z))))) ))
(assert (not (forall ((x Lst) (y Lst)) (= (half (len (append x y))) (half (len (append y x)))) )))
(check-sat)
(exit)
