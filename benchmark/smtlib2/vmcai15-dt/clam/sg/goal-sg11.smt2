...
(assert (forall ((x Lst) (y Lst) (z Nat)) (= (rev (append x (append y (cons z nil)))) (cons z (rev (append x y)))) ))
(assert (forall ((x Lst) (y Nat)) (= (rev (append (append x (cons y nil)) nil)) (cons y (rev (append x nil)))) ))
(assert (not (forall ((x Lst) (y Lst)) (= (rev (append (rev x) (rev y))) (append y x)) )))
(check-sat)
(exit)
