...
(assert (forall ((x Lst) (y Nat) (z Lst)) (= (append (append x (cons y nil)) z) (append x (cons y z))) ))
(assert (forall ((x Lst) (y Lst) (z Nat)) (= (append (append x y) (cons z nil)) (append x (append y (cons z nil)))) ))
(assert (not (forall ((x Lst) (y Lst)) (= (rotate (len x) (append x y)) (append y x)) )))
(check-sat)
(exit)
