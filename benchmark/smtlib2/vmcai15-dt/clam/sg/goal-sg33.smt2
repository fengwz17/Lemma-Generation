...
(assert (forall ((n Nat)) (= (fac (succ n)) (mult (fac n) n)) ))
(assert (forall ((n Nat)) (= (qfac zero n) n) ))
(assert (forall ((n Nat) (m Nat)) (= (qfac (succ n) m) (qfac n (mult m n))) ))
(assert (forall ((x Nat) (y Nat)) (= (mult (fac x) y) (qfac x y)) ))
(assert (not (forall ((x Nat)) (= (fac x) (qfac x (succ zero))) )))
(check-sat)
(exit)
