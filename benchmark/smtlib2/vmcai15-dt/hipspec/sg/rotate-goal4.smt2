...
(assert (forall ((n Nat) (m Nat) (x Lst)) (= (rotate n (rotate m x)) (rotate m (rotate n x))) ))
(assert (not (forall ((n Nat) (m Nat) (x Lst)) (= (rotate (succ n) (rotate m x)) (rotate (succ m) (rotate n x))) )))
(check-sat)
(exit)
