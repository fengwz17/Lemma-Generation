...
(assert (forall ((x Lst) (y Lst)) (= (append (rev x) (rev y)) (rev (append y x))) ))
(assert (forall ((x Lst) (y Lst) (z Lst)) (= (append (qreva x y) z) (qreva x (append y z))) ))
(assert (not (forall ((x Lst) (y Lst)) (= (qreva x (rev y)) (rev (append y x))) )))
(check-sat)
(exit)
