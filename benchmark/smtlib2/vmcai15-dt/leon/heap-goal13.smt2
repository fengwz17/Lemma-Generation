...
(declare-datatypes ((Heap 0)) (((hleaf) (heap (rk Nat) (value Nat) (hleft Heap) (hright Heap)))
))
...
(assert (forall ((k Nat) (v Nat) (l Heap) (r Heap)) (= (hasLeftistProperty (heap k v l r)) (and (hasLeftistProperty l) (hasLeftistProperty r) (leq (rightHeight r) (rightHeight l)) (= k (succ (rightHeight r))))) ))
...
(assert (forall ((k1 Nat) (v1 Nat) (l1 Heap) (r1 Heap) (k2 Nat) (v2 Nat) (l2 Heap) (r2 Heap)) (= (merge (heap k1 v1 l1 r1) (heap k2 v2 l2 r2)) (ite (less v2 v1) (mergea v1 l1 (merge r1 (heap k2 v2 l2 r2))) (mergea v2 l2 (merge (heap k1 v1 l1 r1) r2)))) ))
...
(assert (forall ((n Lst) (x Heap)) (=> (hasLeftistProperty x) (hasLeftistProperty (hinsert-all n x))) ))
(assert (forall ((v Nat) (x Heap) (y Heap)) (=> (and (hasLeftistProperty x) (hasLeftistProperty y)) (hasLeftistProperty (mergea v x y))) ))
(assert (forall ((x Heap) (y Heap)) (=> (and (hasLeftistProperty x) (hasLeftistProperty y)) (hasLeftistProperty (merge x y))) ))
(assert (forall ((l Lst)) (hasLeftistProperty (hinsert-all l hleaf)) ))
(assert (forall ((v Nat) (x Heap) (y Heap)) (=> (and (hasLeftistProperty x) (hasLeftistProperty y)) (= (hsize (mergea v x y)) (succ (plus (hsize x) (hsize y))))) ))
(assert (forall ((x Heap) (y Heap)) (=> (and (hasLeftistProperty x) (hasLeftistProperty y)) (= (hsize (merge x y)) (plus (hsize x) (hsize y)))) ))
(assert (forall ((x Heap) (n Nat)) (=> (hasLeftistProperty x) (= (hsize (hinsert x n)) (succ (hsize x)))) ))
(assert (forall ((l Lst) (x Heap)) (=> (hasLeftistProperty x) (= (hsize (hinsert-all l x)) (plus (hsize x) (len l)))) ))
(assert (forall ((x Heap)) (=> (hasLeftistProperty x) (= (len (heapsorta x)) (hsize x))) ))
(assert (forall ((l Lst)) (sorted (heapsort l)) ))
(assert (forall ((x Heap) (l Lst) (v Nat)) (=> (hasLeftistProperty x) (= (len (qheapsorta x (cons v l))) (succ (len (qheapsorta x l))))) ))
(assert (not (forall ((l Lst) (x Heap)) (=> (hasLeftistProperty x) (= (len (qheapsorta x l)) (plus (hsize x) (len l)))) )))
(check-sat)
(exit)
