...
(assert (tsorted leaf))
(assert (forall ((d Nat) (l Tree) (r Tree)) (= (tsorted (node d l r)) (and (tsorted l) (tsorted r) (forall ((x Nat)) (=> (tcontains l x) (leq x d)) ) (forall ((x Nat)) (=> (tcontains r x) (less d x)) ))) ))
...
(assert (forall ((t Tree) (n Nat)) (= (tsize (tinsert t n)) (succ (tsize t))) ))
(assert (forall ((l Lst) (t Tree)) (leq (tsize t) (tsize (tinsert-all t l))) ))
(assert (forall ((l Lst) (t Tree)) (= (tsize (tinsert-all t l)) (plus (tsize t) (len l))) ))
(assert (forall ((t Tree) (n Nat)) (leq (tsize (tremove t n)) (tsize t)) ))
(assert (forall ((l Lst) (t Tree)) (leq (tsize (tremove-all t l)) (tsize t)) ))
(assert (forall ((x Tree) (i Nat)) (tcontains (tinsert x i) i) ))
(assert (forall ((i Nat) (x Tree) (j Nat)) (= (or (= i j) (tcontains x j)) (tcontains (tinsert x i) j)) ))
(assert (forall ((x Tree) (i Nat)) (=> (tsorted x) (tsorted (tinsert x i))) ))
(assert (forall ((x Tree) (i Nat)) (tmember (tinsert x i) i) ))
(assert (forall ((i Nat) (x Tree) (j Nat)) (= (or (= i j) (tmember x j)) (tmember (tinsert x i) j)) ))
(assert (forall ((i Nat) (x Tree)) (=> (tsorted x) (= (tcontains x i) (tmember x i))) ))
(assert (forall ((i Nat) (x Tree)) (=> (tmember x i) (tcontains x i)) ))
(assert (forall ((l Lst) (x Tree) (n Nat)) (= (tinsert-all (tinsert x n) l) (tinsert-all x (append l (cons n nil)))) ))
(assert (forall ((x Lst)) (tsorted (tinsert-all leaf x)) ))
(assert (forall ((x Lst) (i Nat)) (= (mem i x) (tcontains (tinsert-all leaf x) i)) ))
(assert (forall ((x Lst) (y Lst) (i Nat)) (= (mem i (append x y)) (or (mem i x) (mem i y))) ))
(assert (forall ((x Tree) (i Nat)) (=> (tsorted x) (= (tmember x i) (mem i (content x)))) ))
(assert (not (forall ((x Tree) (i Nat)) (= (tcontains x i) (mem i (content x))) )))
(check-sat)
(exit)
