...
(assert (forall ((x Int)) (= (delete x nil) nil)))
(assert (forall ((x Int) (y Int) (z Lst)) (= (delete x (cons y z)) (ite (= x y) (delete x z) (cons y (delete x z))))))
(assert (not 
(forall ((x Int) (l Lst)) (leq (len (delete x l)) (len l))) ; G69 
))
(check-sat)
