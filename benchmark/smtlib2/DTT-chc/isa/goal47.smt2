...
(assert (forall ((n Int) (m Int)) (=> (and (>= n 0) (>= m 0)) (= (nmax n m) (ite (less n m) m n)))))
;;; (assert (forall ((n Int) (m Int)) (=> (and (>= n 0) (>= m 0)) (>= (nmax n m) 0))))
...
(assert (not 
(forall ((a Tree)) (= (height (mirror a)) (height a))) ; G47 
))
(check-sat)
