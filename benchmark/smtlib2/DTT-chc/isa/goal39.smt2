...
(assert (forall ((x Int) (y Int) (z Lst)) (= (count x (cons y z)) (ite (= x y) (+ 1 (count x z)) (count x z)))))
;;; (assert (forall ((x Int) (y Lst)) (>= (count x y) 0)))
(assert (not 
(forall ((n Int) (h Int) (t Lst)) (= (plus (count n (cons h nil)) (count n t)) (count n (cons h t)))) ; G39 
))
(check-sat)
