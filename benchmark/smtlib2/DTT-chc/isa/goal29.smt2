...
(assert (forall ((i Int)) (= (ins1 i nil) (cons i nil))))
(assert (forall ((i Int) (x Int) (y Lst)) (= (ins1 i (cons x y)) (ite (= i x) (cons x y) (cons x (ins1 i y))))))
(assert (not 
(forall ((x Int) (l Lst)) (mem x (ins1 x l))) ; G29 
))
(check-sat)
