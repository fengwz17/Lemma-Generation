...
; heaps
(declare-datatypes ((Heap 0)) (((hleaf) (heap (rk Int) (value Int) (hleft Heap) (hright Heap)))))
...
(forall ((l Lst) (x Heap)) (=> (hasLeftistProperty x) (= (len (qheapsorta x l)) (plus (hsize x) (len l))))) ; G-heap-13 
